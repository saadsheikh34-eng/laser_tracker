...
# Path of this script: C:\Users\Saad\Desktop\echo_Clone\new_echo-main\pchdmi_system\_ide\scripts\systemdebugger_pchdmi_system_76_standalone.tcl
# 
# 
# Usage with xsct:
...
fpga -file C:/Users/Saad/Desktop/echo_Clone/new_echo-main/pchdmi/_ide/bitstream/FDWITHBOUNDINBOX(DILATION).bit
targets -set -nocase -filter {name =~"APU*"}
loadhw -hw C:/Users/Saad/Desktop/echo_Clone/new_echo-main/pchdmi_hw/export/pchdmi_hw/hw/FDWITHBOUNDINBOX(DILATION).xsa -mem-ranges [list {0x40000000 0xbfffffff}] -regs
